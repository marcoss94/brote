...
export default function WhatsAppDialog({ route, date }: WhatsAppDialogProps) {
      ...
      <DialogContent className="max-w-md">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-1.5">
            ...
            <div className="bg-muted rounded-md p-3 text-[11px] font-mono whitespace-pre-wrap max-h-60 overflow-y-auto border border-border">
              {message}
            </div>
          </div>
        </div>
